...
/**
 * The {@link FreeairHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Bernie Renner - Initial contribution
 */
@NonNullByDefault
@Component(configurationPid = "binding.freeair", service = ThingHandlerFactory.class)
public class FreeairHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_DEVICE.equals(thingTypeUID)) {
            return new FreeairHandler(thing);
        }
